...
public class NetServerHandler extends NetHandler
{
    ...
    public NetServerHandler(MinecraftServer par1, INetworkManager par2,
            EntityPlayerMP par3)
    {
        this.mcServer = par1;
        ...
        if (!this.connectionClosed)
        {
            ...
            this.mcServer.getConfigurationManager().sendPacketToAllPlayers(
                    new Packet3Chat(EnumChatFormatting.YELLOW
                            + this.playerEntity.username + " left the game."));
            ...
            if (this.hasMoved)
            {
                ...
                if (this.playerEntity.ridingEntity != null)
                {
                            ...
                            && par1Packet10Flying.stance == -999.0D)
                    {
                        ...
                        {
                            System.err
                            .println(this.playerEntity.username
                    ...
                    if (this.playerEntity.ridingEntity != null)
                    {
                        var2.uncheckedUpdateEntity(
                                this.playerEntity.ridingEntity, true);
                    }
                        ...
                        .isCreative())
                {
                    var31 = true;
                    this.mcServer.getLogAgent().logWarning(
                            this.playerEntity.username + " moved wrongly!");
                }
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        else
        {
            ...
            if (var3)
            {
                ...
                if (var13 > ZMod.actualReachDigSq()) // -ZMod-Dig-reach
                {
                    return;
                }
            ...
            if (par1Packet14BlockDig.status == 0)
            {
                if (!this.mcServer.func_96290_a(var2, var4, var5, var6,
                        this.playerEntity))
                {
        ...
        else
        {
            if (this.hasMoved
                    && this.playerEntity.getDistanceSq((double) var5 + 0.5D,
                            (double) var6 + 0.5D, (double) var7 + 0.5D) < ZMod
                    .actualReachUseSq()
                    && !this.mcServer.func_96290_a(var2, var5, var6, var7,
                            this.playerEntity)) // -ZMod-Dig-reach
            {
    ...
    public void handleErrorMessage(String par1Str, Object[] par2ArrayOfObj)
    {
        this.mcServer.getLogAgent().logInfo(
                this.playerEntity.username + " lost connection: " + par1Str);
        this.mcServer.getConfigurationManager().sendPacketToAllPlayers(
                new Packet3Chat(EnumChatFormatting.YELLOW
                        + this.playerEntity.getTranslatedEntityName()
                        + " left the game."));
        this.mcServer.getConfigurationManager().playerLoggedOut(
                this.playerEntity);
        this.connectionClosed = true;
        ...
        if (this.mcServer.isSinglePlayer()
                && this.playerEntity.username.equals(this.mcServer
                        .getServerOwner()))
        {
            this.mcServer.getLogAgent().logInfo(
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var2 = "<" + this.playerEntity.getTranslatedEntityName()
                            + "> " + var2;
                ...
                if (this.chatSpamThresholdCount > 200
                        && !this.mcServer.getConfigurationManager()
                        .areCommandsAllowed(this.playerEntity.username))
                {
            ...
            Packet203AutoComplete par1Packet203AutoComplete)
    {
        ...
        for (Iterator var3 = this.mcServer.getPossibleCompletions(
                this.playerEntity, par1Packet203AutoComplete.getText())
                .iterator(); var3.hasNext(); var2.append(var4))
        {
        ...
        else
        {
            ...
            else
            {
                ...
                if ("MC|AdvCdm".equals(par1Packet250CustomPayload.channel))
                {
                    ...
                    {
                        this.playerEntity.sendChatToPlayer(this.playerEntity
                            ...
                            && this.playerEntity.capabilities.isCreativeMode)
                    {
                        try
                        {
                            ...
                            TileEntity var7 = this.playerEntity.worldObj
                        ...
                        && this.playerEntity.openContainer instanceof ContainerRepair)
                {
                    ...
                    {
                        String var15 = ChatAllowedCharacters
