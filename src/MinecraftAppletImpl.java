...
public class MinecraftAppletImpl extends Minecraft
{
    ...
    public MinecraftAppletImpl(MinecraftApplet par1MinecraftApplet,
            Canvas par2Canvas, MinecraftApplet par3MinecraftApplet, int par4,
            int par5, boolean par6)
    {
    ...
    public void startGame() throws LWJGLException
    {
        ...
        if (this.gameSettings.overrideHeight > 0
                && this.gameSettings.overrideWidth > 0
                && this.mainFrame.getParent() != null
                && this.mainFrame.getParent().getParent() != null)
        {
            this.mainFrame
            .getParent()
            .getParent()
            .setSize(this.gameSettings.overrideWidth,
                    this.gameSettings.overrideHeight);
        }
