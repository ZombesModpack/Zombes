...
public class PlayerControllerMP
{
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            if (this.func_85182_a(par1, par2, par3))
            {
                ...
                {
                    //-ZMod-Cheat---------------------------------------------
                    if (this.isHittingBlock) ZMod.afterBlockDig();
                    //--------------------------------------------------------
                    this.isHittingBlock = false;
                    return;
                }
    ...
    public void switchToRealItem() {
        ...
        if (realItem != this.currentPlayerItem) {
            this.netClientHandler.addToSendQueue(new Packet16BlockItemSwitch(realItem));
        }
    }
    ...
    {
        //-ZMod-Dig-check-----------------------------------------------------
        if (!ZMod.digCheckReachUse(par4,par5,par6,par7)) return false;
        //--------------------------------------------------------------------
        this.syncCurrentPlayItem();
        ...
        {
            //-ZMod-Cheat-projection------------------------------------------
            boolean ret = par3ItemStack.tryPlaceItemIntoWorld(par1EntityPlayer, par2World, par4, par5, par6, par7, var9, var10, var11);
            ZMod.afterBlockPlace();
            return ret;
            //----------------------------------------------------------------
        }
